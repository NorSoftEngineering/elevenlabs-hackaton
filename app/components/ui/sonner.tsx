		...
		<Sonner
			...
			toastOptions={{
				classNames: {
					...
					info: 'group toast group-[.toaster]:bg-background group-[.toaster]:border-border group-[.toaster]:text-foreground data-[type=info]:group-[.toaster]:border-l-4 data-[type=info]:group-[.toaster]:border-l-blue-500',
					warning:
