...
export function InterviewPerformance({ stats, previousStats }: InterviewPerformanceProps) {
  ...
  const previousCompletionRate = previousStats?.totalInterviews === 0 ? 0 : 
    previousStats ? (previousStats.completedInterviews / previousStats.totalInterviews) * 100 : undefined;
