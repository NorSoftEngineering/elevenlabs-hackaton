import { CheckCircleIcon, ClockIcon, ListBulletIcon } from '@heroicons/react/24/outline';
...
export function CheckpointAnalysis({ stats, previousStats }: CheckpointAnalysisProps) {
	...
	const previousCompletionRate =
		previousStats?.totalCheckpoints === 0
			? 0
			: previousStats
				? (previousStats.completedCheckpoints / previousStats.totalCheckpoints) * 100
				: undefined;
	...
	const topicFrequency = stats.allTopics.reduce(
		(acc, topic) => {
