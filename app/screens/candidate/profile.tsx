	...
	return (
		<div className="p-6 max-w-4xl mx-auto">
			<div className="flex justify-between items-center mb-6">
				...
				<Link to="/candidate/profile/edit" className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">
					Complete Profile
				</Link>
			</div>
				...
				<div className="p-6">
					<div className="text-center py-12">
						...
						<p className="text-gray-600 mb-6 max-w-md mx-auto">
							Tell us about yourself! Complete your profile to help companies learn more about your skills and
							experience.
						</p>
						<Link to="/candidate/profile/edit" className="inline-flex items-center text-blue-600 hover:text-blue-800">
							Get Started →
						</Link>
					</div>
				</div>
...
export default function ProfileScreen() {
	...
	const isProfileEmpty =
		!profile.name && !profile.title && !profile.bio && (!profile.skills || profile.skills.length === 0);
