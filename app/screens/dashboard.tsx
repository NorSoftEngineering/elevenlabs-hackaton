              ...
              <ul className="-mb-8">
                <li className="relative pb-8">
                  <div className="relative flex space-x-3">
                    ...
                    <div className="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                      <div>
                        <p className="text-sm text-gray-500">Interview completed for <span className="font-medium text-gray-900">Sarah Chen - Senior Frontend Engineer</span></p>
                      </div>
                ...
                <li className="relative pb-8">
                  <div className="relative flex space-x-3">
                    ...
                    <div className="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                      <div>
                        <p className="text-sm text-gray-500">Manual review needed for <span className="font-medium text-gray-900">Alex Kim - DevOps Engineer</span></p>
                      </div>
                      <div className="text-right text-sm whitespace-nowrap text-gray-500">
